...
let chart_list=document.querySelectorAll("div.bloodmallet_chart");for(const html_element of chart_list){let html_id=undefined;try{html_id=html_element.id}catch(error){console.log("No bloodmallet_chart was found.");return}
