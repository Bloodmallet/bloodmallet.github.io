...
link+=".wowhead.com/";try{let item_id=data.item_ids[key];link+="item="+item_id;link+="/"+slugify(key)}catch(error){if(debug){console.log(error);console.log("We're probably looking at a spell.")}}
...
link+="&ilvl="+ilvl}
try{let spell_id=data.spell_ids[key];link+="spell="+spell_id;link+="/"+slugify(key)}catch(error){if(debug){console.log(error);console.log("We're probably looking at an item.")}}
link+="\">";try{link+=data.languages[key][language_table[state.language]]}catch(error){link+=key;console.log("Bloodmallet charts: Translation for "+key+" wasn't found. Please help improving the reasource at bloodmallet.com.")}
link+="</a>";return link}
if(state.tooltip_engine=="wowdb"){let element_string="<a href=\"";let link="http://www.wowdb.com/";try{let item_id=data.item_ids[key];link+="items/"+item_id}catch(error){if(debug){console.log(error);console.log("We're probably looking at a spell.")}}
...
try{let spell_id=data.spell_ids[key];link+="spells/"+spell_id}catch(error){if(debug){console.log(error);console.log("We're probably looking at an item.")}}
element_string+=link;element_string+="\" data-tooltip-href=\"";element_string+=link+"\">";try{element_string+=data.languages[key][language_table[state.language]]}catch(error){element_string+=key;console.log("Bloodmallet charts: Translation for "+key+" wasn't found. Please help improving the reasource at bloodmallet.com.")}
element_string+="</a>";return element_string}}
